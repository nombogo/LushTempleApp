...
class _MoisturizersState extends State<Moisturizers> {
          ...
          child: Column(
            ...
            children: [
              ...
              GridView.builder(
                ...
                itemCount: productProvider.moisturizerProducts.length,
                itemBuilder: (context, index) {
                  final product = productProvider.moisturizerProducts[index];
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      body: const Center(child: Column(children: [Text('Moisturizers')],),),
    );
  }
